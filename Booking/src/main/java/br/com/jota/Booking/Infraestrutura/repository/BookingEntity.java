...
public class BookingEntity {
    ...
    public BookingEntity(Integer roomNumber, String email, String nameGuest, BigDecimal totalPrice, String telephone, String message, BookingStatus status, LocalDateTime checkIn, LocalDateTime checkOut, String guestCpf) {
